...
import com.szadowsz.binary.exception.DataOverflowException;
...
public class ByteArrayEditableData extends ByteArrayData implements EditableBinaryData {
    ...
    public void insert(long startFrom, BinaryData insertedData) {
        ...
        if (insertedData instanceof ByteArrayData byteArrayData) {
            insert(startFrom, byteArrayData.data);
        } else {
    ...
    public void insert(long startFrom, BinaryData insertedData, long insertedDataOffset, long insertedDataLength) {
        ...
        if (insertedData instanceof ByteArrayData byteArrayData) {
            ...
            insert(startFrom, byteArrayData.data, (int) insertedDataOffset, (int) insertedDataLength);
        } else {
    ...
    public void replace(long targetPosition, BinaryData replacingData, long startFrom, long replacingLength) {
        ...
        if (replacingData instanceof ByteArrayData byteArrayData) {
            replace(targetPosition, byteArrayData.data, (int) startFrom, (int) replacingLength);
        } else {
