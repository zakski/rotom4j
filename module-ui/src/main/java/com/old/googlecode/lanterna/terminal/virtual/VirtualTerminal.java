 ...
 */
package com.old.googlecode.lanterna.terminal.virtual;
...
public interface VirtualTerminal extends IOSafeTerminal {
     ...
     * not the same as the list of {@link TerminalResizeListener}, but as the
     ...
     * same as the list of {@link TerminalResizeListener}.
