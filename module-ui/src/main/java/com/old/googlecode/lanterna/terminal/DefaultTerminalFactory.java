 ...
 */
package com.old.googlecode.lanterna.terminal;

import com.old.googlecode.lanterna.TerminalSize;
import com.old.googlecode.lanterna.screen.TerminalScreen;
import com.old.googlecode.lanterna.terminal.ansi.*;
import com.old.googlecode.lanterna.terminal.swing.*;
...
public class DefaultTerminalFactory implements TerminalFactory {
    ...
    private Terminal createWindowsTerminal() throws IOException {
        try {
            Class<?> nativeImplementation = Class.forName("com.old.googlecode.lanterna.terminal.win32.WindowsTerminal");
