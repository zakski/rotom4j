 ...
 */
package com.old.googlecode.lanterna.screen;
...
import com.old.googlecode.lanterna.graphics.Scrollable;
import com.old.googlecode.lanterna.graphics.TextGraphics;
import com.old.googlecode.lanterna.input.InputProvider;
...
public interface Screen extends InputProvider, Scrollable, Closeable {
     ...
     * {@link Terminal} (where applicable), which will restore things like echo mode,
