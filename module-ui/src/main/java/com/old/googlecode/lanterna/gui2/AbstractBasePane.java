...
import com.old.googlecode.lanterna.gui2.Interactable.Result;
import com.old.googlecode.lanterna.gui2.menu.MenuBar;
...
public abstract class AbstractBasePane<T extends BasePane> implements BasePane {
    ...
    private boolean doHandleInput(KeyStroke key) {
        ...
        if(focusedInteractable == null) {
            ...
            Result handleResult = focusedInteractable.handleInput(key);
