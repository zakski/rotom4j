...
public class SliderNode extends AbstractNode {
    ...
    protected void updateBackgroundShader(PGraphics pg) {
        PShader shader = ShaderStore.getorLoadShader(shaderPath);
        ...
        shader.set("colorA", NormColorStore.red(bgColor), NormColorStore.green(bgColor), NormColorStore.blue(bgColor));
        shader.set("colorB", NormColorStore.red(fgColor), NormColorStore.green(fgColor), NormColorStore.blue(fgColor));
    ...
    @Override
    public void mouseWheelEvent(GuiMouseEvent e) {
...
//        }
    ...
    private void tryReadNumpadInput(GuiKeyEvent e) {
