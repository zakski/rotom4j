...
import com.old.krab.lazy.LazyGui;
...
import com.old.krab.lazy.utils.ClipboardUtils;
import com.old.krab.lazy.utils.KeyCodes;
import processing.core.PGraphics;

import static com.old.krab.lazy.stores.LayoutStore.cell;
import static com.old.krab.lazy.stores.NormColorStore.getColorStoreHSB;
...
public class ColorPickerFolderNode extends FolderNode {
    ...
    public void loadValuesFromHex(boolean setDefaults) {
        lazyInitNodes();
        PGraphics colorProvider = getColorStoreHSB();
