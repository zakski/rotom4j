package com.old.krab.lazy.windows;

import com.old.krab.lazy.input.UserInputPublisher;
import com.old.krab.lazy.input.UserInputSubscriber;
...
import com.old.krab.lazy.nodes.impl.FolderNode;
import com.old.krab.lazy.stores.FontStore;
import com.old.krab.lazy.stores.GlobalReferences;
import com.old.krab.lazy.stores.LayoutStore;
import com.old.krab.lazy.stores.NodeTree;
import com.old.krab.lazy.themes.ThemeStore;
import com.old.krab.lazy.utils.MouseHiding;
import com.old.krab.lazy.utils.NodePaths;
...
import static com.old.krab.lazy.themes.ThemeColorType.*;
            ...
            if (startIndex >= 0){
                ...
                if (e.getRotation() < 0){
                    ...
                    while (index < folder.children.size()) {
                        ...
                        if (sum + child.masterInlineNodeHeightInCells * LayoutStore.cell > posY + windowSizeY + 10){
                            index -= 1;
                            break;
                        }
                        sum += child.masterInlineNodeHeightInCells * LayoutStore.cell;
