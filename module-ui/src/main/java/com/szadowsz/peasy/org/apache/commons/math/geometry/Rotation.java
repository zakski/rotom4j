...
package com.szadowsz.peasy.org.apache.commons.math.geometry;
 ...
 * transforms three dimensional {@link com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D vectors} into other three
 * dimensional {@link com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D vectors}. Depending on the application, the
 ...
 * generic methods: {@link #applyTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D) applyTo(Vector3D)} and
 * {@link #applyInverseTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D) applyInverseTo(Vector3D)}.
 * </p>
 * 
 * <p>
 ...
 *          2008) $
 * @see com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D
 * @see RotationOrder
 * @since 1.2
 */
...
public class Rotation implements Serializable {
	 ...
	 * angle to this constructor, and then {@link #applyTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D) apply} the
	 ...
	 */
	public Rotation(final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D axis, final double angle) {
	 ...
	 */
	public Rotation(final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D u1, final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D u2, com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v1, com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v2) {

		// norms computation
		final double u1u1 = com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.dotProduct(u1, u1);
		final double u2u2 = com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.dotProduct(u2, u2);
		final double v1v1 = com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.dotProduct(v1, v1);
		final double v2v2 = com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.dotProduct(v2, v2);
		...
		v1 = new com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D(v1x, v1y, v1z);

		// adjust v2 in order to have (u1|u2) = (v1|v2) and (v2'|v2') = (u2|u2)
		final double u1u2 = com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.dotProduct(u1, u2);
		final double v1v2 = com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.dotProduct(v1, v2);
		...
		v2 = new com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D(v2x, v2y, v2z);
		...
		com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D uRef = u1;
		com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D vRef = v1;
		...
		com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D k = new com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D(dy1 * dz2 - dz1 * dy2, dz1 * dx2 - dx1 * dz2, dx1 * dy2
				- dy1 * dx2);
		...
		if (c == 0) {
			...
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D u3 = com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.crossProduct(u1, u2);
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v3 = com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.crossProduct(v1, v2);
			...
			k = new com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D(dy1 * dz3 - dz1 * dy3, dz1 * dx3 - dx1 * dz3, dx1 * dy3
					- dy1 * dx3);
			...
			if (c == 0) {
				...
				k = new com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D(dy2 * dz3 - dz2 * dy3, dz2 * dx3 - dx2 * dz3, dx2 * dy3
						- dy2 * dx3);
		...
		k = new com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D(uRef.getY() * q3 - uRef.getZ() * q2, uRef.getZ() * q1
				- uRef.getX() * q3, uRef.getX() * q2 - uRef.getY() * q1);
		c = com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.dotProduct(k, k);
		q0 = com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.dotProduct(vRef, k) / (c + c);
	 ...
	 *                if the norm of one of the vectors is zero
	 */
	public Rotation(final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D u, final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v) {
		...
		final double dot = com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.dotProduct(u, v);

		if (dot < ((2.0e-15 - 1.0) * normProduct)) {
			// special case u = -v: we select a PI angle rotation around
			// an arbitrary vector orthogonal to u
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D w = u.orthogonal();
			q0 = 0.0;
			q1 = -w.getX();
			q2 = -w.getY();
			q3 = -w.getZ();
	 ...
	 */
	public com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D getAxis() {
		final double squaredSine = q1 * q1 + q2 * q2 + q3 * q3;
		if (squaredSine == 0) {
			return new com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D(1, 0, 0);
		} else if (q0 < 0) {
			final double inverse = 1 / Math.sqrt(squaredSine);
			return new com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D(q1 * inverse, q2 * inverse, q3 * inverse);
		}
		final double inverse = -1 / Math.sqrt(squaredSine);
		return new com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D(q1 * inverse, q2 * inverse, q3 * inverse);
	}
	 ...
	 * @exception com.szadowsz.peasy.org.apache.commons.math.geometry.CardanEulerSingularityException
	 *                if the rotation is singular with respect to the angles set
	 *                specified
	 */
	public double[] getAngles(final RotationOrder order)
			throws com.szadowsz.peasy.org.apache.commons.math.geometry.CardanEulerSingularityException {
		...
		if (order == RotationOrder.XYZ) {
			...
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v1 = applyTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.plusK);
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v2 = applyInverseTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.plusI);
			if ((v2.getZ() < -0.9999999999) || (v2.getZ() > 0.9999999999)) {
				throw new com.szadowsz.peasy.org.apache.commons.math.geometry.CardanEulerSingularityException(true);
			}
			...
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v1 = applyTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.plusJ);
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v2 = applyInverseTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.plusI);
			...
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v1 = applyTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.plusK);
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v2 = applyInverseTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.plusJ);
			if ((v2.getZ() < -0.9999999999) || (v2.getZ() > 0.9999999999)) {
				throw new com.szadowsz.peasy.org.apache.commons.math.geometry.CardanEulerSingularityException(true);
			}
			...
			// and we can choose to have psi in the interval [-PI/2 ; +PI/2]
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v1 = applyTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.plusI);
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v2 = applyInverseTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.plusJ);
			...
			// and we can choose to have phi in the interval [-PI/2 ; +PI/2]
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v1 = applyTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.plusJ);
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v2 = applyInverseTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.plusK);
			if ((v2.getY() < -0.9999999999) || (v2.getY() > 0.9999999999)) {
				throw new com.szadowsz.peasy.org.apache.commons.math.geometry.CardanEulerSingularityException(true);
			}
			...
			final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D v2 = applyInverseTo(com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D.plusI);
			if ((v2.getX() < -0.9999999999) || (v2.getX() > 0.9999999999)) {
				throw new com.szadowsz.peasy.org.apache.commons.math.geometry.CardanEulerSingularityException(false);
			}
			return new double[] { Math.atan2(v1.getY(), -v1.getZ()),
	 ...
	 */
	public com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D applyTo(final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D u) {
		...
		return new com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D(2 * (q0 * (x * q0 - (q2 * z - q3 * y)) + s * q1) - x, 2
	 ...
	 */
	public com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D applyInverseTo(final com.szadowsz.peasy.org.apache.commons.math.geometry.Vector3D u) {
