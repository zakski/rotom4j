...
class GScrollbar extends GAbstractControl {
	...
	public GScrollbar(PApplet theApplet, float p0, float p1, float p2, float p3) {
		...
		makeBuffer();
		hotspots = new HotSpot[] { new HotSpot.HSrect(1, 0, 0, 16, height), // low cap
				new HotSpot.HSrect(2, width - 16, 0, 16, height), // high cap
				new HotSpot.HSrect(9, 17, 0, width - 17, height) // thumb track
		};
