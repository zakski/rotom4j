...
public class GDropList extends GTextBase {
	...
	public GDropList(PApplet theApplet, float p0, float p1, float p2, float p3, int listSize, float buttonWidth) {
		...
		hotspots = new HotSpot[] {
				new HotSpot.HSrect(LIST_SURFACE, 0, itemHeight + 1, width - buttonWidth - 1, height - itemHeight - 1), // text
																												// list
																												// area
				new HotSpot.HSrect(CLOSED_SURFACE, 0, 0, width - buttonWidth, itemHeight) // selected text display area
		};
