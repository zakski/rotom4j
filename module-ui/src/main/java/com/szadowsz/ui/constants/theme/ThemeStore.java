package com.szadowsz.ui.constants.theme;
...
public class ThemeStore {
    ...
    public static void setCustomPaletteAndMakeDefaultBeforeInit(Theme theme) {
        defaultThemeType = ThemeType.CUSTOM.getName();
        paletteMap.put(ThemeType.CUSTOM, theme);
    }
    public static void selectThemeByTypeBeforeInit(ThemeType typeToSelect){
        defaultThemeType = typeToSelect.getName();
    }

    public static void init() {
        ThemeType[] allTypes = ThemeType.values();
...
//            String userSelection = GlobalReferences.gui.radio("preset", ThemeType.getAllNames(), defaultThemeType).valueString;
//
