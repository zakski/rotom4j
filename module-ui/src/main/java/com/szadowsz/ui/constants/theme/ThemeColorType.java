...
/**
 * Colors types of the Theme
 */
public enum ThemeColorType {
    WINDOW_BORDER,
    NORMAL_BACKGROUND, // TEXT_BACKGROUND
    FOCUS_BACKGROUND, // SELECTION_BACKGROUND
    NORMAL_FOREGROUND, // TEXT_COLOR
    FOCUS_FOREGROUND, // SELECTION_COLOR
