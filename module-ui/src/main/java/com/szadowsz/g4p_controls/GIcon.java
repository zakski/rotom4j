...
/**
 * 
 * Class for the creation of non-animated icons to be used with GButton, GLabel,
...
public class GIcon {
	...
	/**
	 * Get the image to be displayed for the specified frame number. The supplied
	 * frame number will be constrained to a valid value.
	 * 
