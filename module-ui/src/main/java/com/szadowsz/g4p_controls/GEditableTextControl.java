...
import com.szadowsz.g4p_controls.StyledString.TextLayoutHitInfo;
import com.szadowsz.g4p_controls.StyledString.TextLayoutInfo;
...
public abstract class GEditableTextControl extends GTextBase implements Focusable {
	...
	public void setPromptText(String ptext) {
		if (ptext == null || ptext.length() == 0)
			...
			promptText.addAttribute(G4P.POSTURE, POSTURE_OBLIQUE);
		}
		bufferInvalid = true;
	}
