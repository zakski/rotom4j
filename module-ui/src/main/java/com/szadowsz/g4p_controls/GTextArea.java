...
import com.szadowsz.g4p_controls.HotSpot.HSrect;
...
public class GTextArea extends GEditableTextControl {
	...
	public boolean insertText(String text, int lineNo, int charNo, boolean startWithEOL, boolean endWithEOL) {
		if (text != null && text.length() > 0) {
			...
			if (change != 0) {
				...
				pos += change;
				StyledString.TextLayoutHitInfo tlhi = stext.getTLHIforCharPosition(pos);
				if (tlhi != null) {
	...
	public String getText(int lineNo) {
		...
		if (lineNo < 0 || lineNo >= lines.size())
			return "";
		StyledString.TextLayoutInfo tli = lines.get(lineNo);
	 ...
	 */
	protected boolean moveCaretStartOfLine(StyledString.TextLayoutHitInfo currPos) {
	...
	protected boolean moveCaretEndOfLine(StyledString.TextLayoutHitInfo currPos) {
	...
	protected boolean moveCaretStartOfText(StyledString.TextLayoutHitInfo currPos) {
	...
	protected boolean moveCaretEndOfText(StyledString.TextLayoutHitInfo currPos) {
	...
	protected boolean moveCaretUp(StyledString.TextLayoutHitInfo currPos) {
		if (currPos.tli.lineNo == 0)
			return false;
		StyledString.TextLayoutInfo ntli = stext.getTLIforLineNo(currPos.tli.lineNo - 1);
	...
	protected boolean moveCaretDown(StyledString.TextLayoutHitInfo currPos) {
	 ...
	 */
	protected boolean moveCaretLeft(StyledString.TextLayoutHitInfo currPos) {
		StyledString.TextLayoutInfo ntli;
	 ...
	 * @return true if caret was moved else false
	 */
	protected boolean moveCaretRight(StyledString.TextLayoutHitInfo currPos) {
		StyledString.TextLayoutInfo ntli;
	...
	public void moveCaretTo(int lineNo, int charNo) {
		try {
			StyledString.TextLayoutHitInfo tlhi = stext.getTLHIforCharPosition(lineNo, charNo);
			if (tlhi != null) {
	...
	protected void calculateCaretPos(StyledString.TextLayoutHitInfo tlhi) {
