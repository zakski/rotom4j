...
package com.szadowsz.g4p_controls;
...
public abstract class GWindow extends PApplet implements GConstants, GConstantsInternal {
	...
	/**
	 * Factory method to create and start a new window. The renderer must be JAVA2D,
	 * P2D or P3D otherwise this method returns null.
	 * 
	...
	/**
	 * Unregister this window for pre, draw, post, mouseEvent and keyEvent methods.
	...
	/**
	 * To provide a unique fields for this window create a class that inherits from
	 * GWinData with public access fields. Then use this method to associate the
	 * data with this window.
	 * 
	...
	/**
	 * Invalidate all the buffers so that they have to be updated before being
	 * drawn.
	 * 
	...
	public void draw() {
		...
		if (drawHandlerObject != null) {
			try {
				...
				GMessenger.message(EXCP_IN_HANDLER, new Object[] { drawHandlerObject, drawHandlerMethodName, e });
			}
		}
		popMatrix();
	}
	...
	public void pre() {
		if (preHandlerObject != null) {
			try {
				...
				GMessenger.message(EXCP_IN_HANDLER, new Object[] { preHandlerObject, preHandlerMethodName, e });
			}
		}
	 ...
	 * Add/remove any controls request by user, this is done here outside the
	 * drawing phase to prevent crashes.
	 */
	public void post() {
		if (postHandlerObject != null) {
			try {
				...
				GMessenger.message(EXCP_IN_HANDLER, new Object[] { postHandlerObject, postHandlerMethodName, e });
			}
		}
		...
		// =====================================================================================================
		// =====================================================================================================
		// This is where components are removed or added to the window to avoid
	...
	public void mouseEvent(MouseEvent event) {
		if (mouseHandlerObject != null) {
			try {
				...
				GMessenger.message(EXCP_IN_HANDLER, new Object[] { mouseHandlerObject, mouseHandlerMethodName, e });
			}
		}
		for (GAbstractControl control : windowControls) {
	...
	public void keyEvent(KeyEvent event) {
		if (keyHandlerObject != null) {
			try {
				...
				GMessenger.message(EXCP_IN_HANDLER, new Object[] { keyHandlerObject, keyHandlerMethodName, e });
			}
		}
		for (GAbstractControl control : windowControls) {
	...
	/**
	 * Attempt to add the 'draw' handler method. The default event handler is a
	 * method that returns void and has two parameters PApplet and GWinData
	 * 
	...
	public void addDrawHandler(Object obj, String methodName) {
		try {
			...
			GMessenger.message(NONEXISTANT,
					new Object[] { this, methodName, new Class<?>[] { PApplet.class, GWinData.class } });
		}
	}

	/**
	 * Attempt to add the 'pre' handler method. The default event handler is a
	 * method that returns void and has two parameters GWinApplet and GWinData
	 * 
	 * @param obj        the object to handle the event
	 * @param methodName the method to execute in the object handler class
	 */
	...
	/**
	 * Attempt to add the 'mouse' handler method. The default event handler is a
	 * method that returns void and has three parameters GWinApplet, GWinData and a
	 * MouseEvent
	 * 
	 * @param obj        the object to handle the event
	 * @param methodName the method to execute in the object handler class
	...
	public void addMouseHandler(Object obj, String methodName) {
		try {
			...
			mouseHandlerObject = null;
			GMessenger.message(NONEXISTANT, new Object[] { this, methodName,
					new Class<?>[] { PApplet.class, GWinData.class, MouseEvent.class } });
		}
	}

	/**
	 * Attempt to add the 'key' handler method. The default event handler is a
	 * method that returns void and has three parameters GWinApplet, GWinData and a
	 * KeyEvent
	 * 
	 * @param obj        the object to handle the event
	...
	/**
	 * Attempt to add the 'post' handler method. The default event handler is a
	 * method that returns void and has two parameters GWinApplet and GWinData
	 * 
	 * @param obj        the object to handle the event
	 * @param methodName the method to execute in the object handler class
	...
	public void addPostHandler(Object obj, String methodName) {
		try {
			postHandlerMethod = obj.getClass().getMethod(methodName, new Class<?>[] { PApplet.class, GWinData.class });
	...
	/**
	 * Attempt to create the on-close-window event handler for this GWindow. The
	 ...
	 * closing) <br>
	 * 
	 * The handler will <b>not be called</b> if the setActionOnClose flag is set to
	 * EXIT_APP <br>
	 ...
	 */
	public void close() {
		if (actionOnClose == KEEP_OPEN || actionOnClose == HIDE_WINDOW || actionOnClose == EXIT_APP)
			return;
	...
	public void performCloseAction() {
		if (closeHandlerObject != null) {
			try {
				...
				GMessenger.message(EXCP_IN_HANDLER, new Object[] { closeHandlerObject, closeHandlerMethodName, e });
			}
		}
	}
	...
	// These next two lists are for controls that are to be added or remove since
	// these
	// actions must be performed outside the draw cycle to avoid concurrent
	// modification
