...
public abstract class GTextBase extends GAbstractControl {
	 ...
	 */
	protected void displayText(Graphics2D g2d, LinkedList<StyledString.TextLayoutInfo> lines, Color fore) {
		float sx = 0, tw = 0;
...
//		System.out.println("Text zone: " + textZone.toString());
	...
	protected void displayText(Graphics2D g2d, LinkedList<StyledString.TextLayoutInfo> lines) {
	...
	public void setTextItalic() {
		addAttributeImpl(G4P.POSTURE, POSTURE_OBLIQUE);
	}
