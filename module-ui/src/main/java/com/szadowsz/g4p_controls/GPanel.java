...
public class GPanel extends GTextBase {
	...
	private void calcHotSpots() {
		hotspots = new HotSpot[] { new HotSpot.HSrect(COLLAPSED_BAR_SPOT, 0, 0, tabWidth, tabHeight), // tab text area
				new HotSpot.HSrect(EXPANDED_BAR_SPOT, 0, 0, width, tabHeight), // tab non-text area
				new HotSpot.HSrect(SURFACE_SPOT, 0, tabHeight, width, height - tabHeight) // panel content surface
		};
	}
