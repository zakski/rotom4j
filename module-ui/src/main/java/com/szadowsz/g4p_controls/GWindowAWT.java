...
/**
 * Class for independent windows using the JAVA2D renderer. These can be used to
 * hold G4P GUI components or used for drawing or both combined. <br>
 * <br>
...
public final class GWindowAWT extends GWindow {
	...
	/**
	 * Fire a window closing event. This method will be called from a new THread, do
	 * not call directly
	 */
