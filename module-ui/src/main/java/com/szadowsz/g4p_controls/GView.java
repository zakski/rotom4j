...
/**
 * A GView control represents a rectangular area of the display window that can
 * have a different renderer to the main sketch. For instance you might have a
 * 3D area (P3D) embedded in a 2D (P2D) sketch. <br>
 * The user must create a listener object (GViewListener) object to respond to
 * mouse events and to update the view graphics.<br>
 * 
 * 
 * @author Peter Lager
 */
final public class GView extends GAbstractView {
	 ...
	 * default JAVA2D. You can create JAVA2D view not matter what renderer the
	 * sketch uses.
	 * 
	...
	/**
	 * Examine the mouse event created by Processing and see if it needs to be
	 * processed by this control. <br>
	 * Do not call this method directly, it it called automatically by G4P at the
	 * appropriate time.
	 */
	public void mouseEvent(MouseEvent event) {
		...
		isOver = (currSpot >= 0);
		// System.out.println("VW " + currSpot + " " + winApp.mouseX + " " +
		// winApp.mouseY + " " + ox + " " + oy);
