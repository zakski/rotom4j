...
import com.szadowsz.gui.component.binary.operation.BinaryDataOperation;
...
public class OverwriteCodeEditDataOperation extends CodeEditDataOperation {
    ...
    public OverwriteCodeEditDataOperation(RCodeAreaCore codeArea, long startPosition, int codeOffset, CodeType codeType, byte value) {
        super(codeArea);
        this.value = value;
    ...
    private static class UndoOperation extends CodeAreaOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(RCodeAreaCore codeArea, long position, BinaryData data, CodeType codeType, int codeOffset, long removeLength) {
            super(codeArea);
