 ...
 */
public class SwingCodeAreaCharAssessor implements CodeAreaCharAssessor {

    protected final SwingCodeAreaCharAssessor parentCharAssessor;
    ...
    public SwingCodeAreaCharAssessor() {
        parentCharAssessor = null;
    }

    public SwingCodeAreaCharAssessor(SwingCodeAreaCharAssessor parentCharAssessor) {
