...
import com.szadowsz.gui.component.oldbined.command.operation.undo.BinaryDataUndoableCommand;
...
public class CodeAreaCompoundCommand extends CodeAreaCommand implements BinaryDataCompoundCommand, BinaryDataAppendableCommand {
    ...
    public CodeAreaCompoundCommand(RBinedAreaCore codeArea) {
        super(codeArea);
    }

    public static CodeAreaCommand buildCompoundCommand(RBinedAreaCore codeArea, CodeAreaCommand... commands) {
