...
import com.szadowsz.gui.component.oldbined.basic.*;
import com.szadowsz.gui.component.oldbined.capabilities.*;
import com.szadowsz.gui.component.oldbined.colors.BasicCodeAreaColorsProfile;
import com.szadowsz.gui.component.oldbined.colors.BasicColorsCapableCodeAreaPainter;
 ...
 */
public class SwingCodeAreaPainter implements CodeAreaPainter, BasicColorsCapableCodeAreaPainter, CodeAreaPaintState, ColorAssessorPainterCapable, CharAssessorPainterCapable {
    ...
    protected final SwingCodeAreaScrollPane scrollPanel;
    protected final SwingCodeAreaMouseListener codeAreaMouseListener;
    ...
    protected final SwingCodeAreaMetrics metrics = new SwingCodeAreaMetrics();
    ...
    protected final SwingCodeAreaDimensions dimensions = new SwingCodeAreaDimensions();
    protected final SwingCodeAreaVisibility visibility = new SwingCodeAreaVisibility();
    ...
    public SwingCodeAreaPainter(RBinedAreaCore codeArea) {
        this.codeArea = codeArea;

        colorAssessor = new SwingCodeAreaColorAssessor();
        charAssessor = new SwingCodeAreaCharAssessor();
        ...
        scrollPanel = new SwingCodeAreaScrollPane((CodeAreaSwingControl) codeArea, metrics, structure, dimensions, scrolling);
        ...
        codeAreaMouseListener = new SwingCodeAreaMouseListener(codeArea, scrollPanel);
        ...
        SwingCodeAreaPainter.this.rebuildColors();
    }
...
//
   ...
   @Override
    ...
    public void paintCursor(Graphics g) {
        ...
        SwingCodeAreaCaret caret = (SwingCodeAreaCaret) ((CaretCapable) codeArea).getCodeAreaCaret();
        ...
        if (cursorVisible) {
            ...
            SwingCodeAreaCaret.CursorRenderingMode renderingMode = caret.getRenderingMode();
    ...
    private void paintCursorRect(Graphics g, int cursorX, int cursorY, int width, int height, SwingCodeAreaCaret.CursorRenderingMode renderingMode, SwingCodeAreaCaret caret) {
    ...
    public CodeAreaCaretPosition mousePositionToClosestCaretPosition(int positionX, int positionY, CaretOverlapMode overflowMode) {
        SwingCodeAreaCaretPosition caret = new SwingCodeAreaCaretPosition();
        CodeAreaScrollPosition scrollPosition = scrolling.getScrollPosition();
        int characterWidth = metrics.getCharacterWidth();
        int rowHeight = metrics.getRowHeight();
        int rowPositionAreaWidth = dimensions.getRowPositionAreaWidth();
    ...
    protected void updateRectToCursorPosition(Rectangle rect, long dataPosition, int codeOffset, CodeAreaSection section) {
        ...
        if (cursorPoint == null) {
            ...
            SwingCodeAreaCaret.CursorShape cursorShape = editOperation == EditOperation.INSERT ? SwingCodeAreaCaret.CursorShape.INSERT : SwingCodeAreaCaret.CursorShape.OVERWRITE;
            int cursorThickness = SwingCodeAreaCaret.getCursorThickness(cursorShape, characterWidth, rowHeight);
