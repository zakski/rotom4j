...
import com.szadowsz.gui.component.bined.swing.SwingCodeAreaCaretPosition;
...
public class BasicCodeAreaLayout {
    ...
    public CodeAreaCaretPosition computeMovePosition(BasicCodeAreaStructure structure, CodeAreaCaretPosition position, MovementDirection direction, int rowsPerPage) {
        ...
        SwingCodeAreaCaretPosition target = new SwingCodeAreaCaretPosition(position.getDataPosition(), position.getCodeOffset(), section);
        switch (direction) {
            case LEFT: {
