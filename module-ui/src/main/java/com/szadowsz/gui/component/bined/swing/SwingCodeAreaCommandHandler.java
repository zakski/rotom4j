...
import com.szadowsz.gui.component.bined.basic.BasicCodeAreaSection;
import com.szadowsz.gui.component.bined.basic.CodeAreaScrollPosition;
 ...
 */
public class SwingCodeAreaCommandHandler implements CodeAreaCommandHandler {
    ...
    public SwingCodeAreaCommandHandler(RBinedAreaCore codeArea) {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(SwingCodeAreaCommandHandler.class.getName()).log(Level.SEVERE, null, ex);
            }
            updateCanPaste();
    ...
    public static CodeAreaCommandHandlerFactory createDefaultCodeAreaCommandHandlerFactory() {
        return SwingCodeAreaCommandHandler::new;
    }
        ...
        try {
            if (clipboard.isDataFlavorAvailable(binaryDataFlavor)) {
                ...
                try {
                    ...
                    Logger.getLogger(SwingCodeAreaCommandHandler.class
