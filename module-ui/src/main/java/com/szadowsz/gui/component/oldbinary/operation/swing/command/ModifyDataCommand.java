...
import com.szadowsz.gui.component.oldbinary.operation.swing.ModifyDataOperation;
...
public class ModifyDataCommand extends OpCodeAreaCommand {
    ...
    public ModifyDataCommand(RCodeAreaCore codeArea, long position, BinaryData data) {
        super(codeArea);
