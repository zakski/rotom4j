...
import com.szadowsz.gui.component.oldbined.command.operation.InsertDataOperation;
...
public class InsertDataCommand extends OpCodeAreaCommand {
    ...
    public InsertDataCommand(RBinedAreaCore codeArea, long position, int codeOffset, BinaryData data) {
        super(codeArea);
