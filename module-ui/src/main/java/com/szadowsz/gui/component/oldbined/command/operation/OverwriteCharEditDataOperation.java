...
import com.szadowsz.gui.component.oldbined.capabilities.CharsetCapable;
...
public class OverwriteCharEditDataOperation extends CharEditDataOperation {
    ...
    public OverwriteCharEditDataOperation(RBinedAreaCore coreArea, long startPosition, char value) {
        super(coreArea);
        this.value = value;
    ...
    private static class UndoOperation extends CodeAreaOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(RBinedAreaCore codeArea, long position, BinaryData data, long removeLength) {
            super(codeArea);
