...
public class InsertCharEditDataOperation extends CharEditDataOperation {
    ...
    public InsertCharEditDataOperation(RBinedAreaCore coreArea, long startPosition, char value) {
        super(coreArea);
        this.value = value;
    ...
    private static class UndoOperation extends CodeAreaOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(RBinedAreaCore codeArea, long position, long length) {
            super(codeArea);
