...
import com.szadowsz.gui.component.binary.operation.BinaryDataCompoundOperation;
...
public class CodeAreaCompoundOperation extends CodeAreaOperation implements BinaryDataCompoundOperation {
    ...
    public CodeAreaCompoundOperation(RCodeAreaCore codeArea) {
        super(codeArea);
    }

    public CodeAreaCompoundOperation(RCodeAreaCore codeArea, CodeAreaCaretPosition backPosition) {
