...
public class RBinScrollPos {
    ...
    public RBinScrollPos() {
    }

    public RBinScrollPos(long rowPosition, int rowOffset, int charPosition, int charOffset) {
    ...
    public boolean equals(Object obj) {
        ...
        final RBinScrollPos other = (RBinScrollPos) obj;
    ...
    public boolean isCharPositionGreaterThan(RBinScrollPos compPosition) {
        return charPosition > compPosition.charPosition || (charPosition == compPosition.charPosition && charOffset > compPosition.charOffset);
    }

    public boolean isRowPositionGreaterThan(RBinScrollPos compPosition) {
