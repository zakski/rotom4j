...
import com.szadowsz.gui.component.bined.basic.BasicCodeAreaScrolling;
import com.szadowsz.gui.component.bined.basic.BasicCodeAreaStructure;
import com.szadowsz.gui.component.bined.settings.ScrollBarVerticalScale;
 ...
 */
public class SwingCodeAreaScrollPane extends JScrollPane {
    ...
    protected final SwingCodeAreaMetrics metrics;
    protected final BasicCodeAreaStructure structure;
    protected final BasicCodeAreaScrolling scrolling;
    protected final SwingCodeAreaDimensions dimensions;
    protected final CodeAreaSwingControl control;

    public SwingCodeAreaScrollPane(CodeAreaSwingControl control, SwingCodeAreaMetrics metrics, BasicCodeAreaStructure structure, SwingCodeAreaDimensions dimensions, BasicCodeAreaScrolling scrolling) {
