...
import com.szadowsz.gui.component.oldbined.command.BinaryDataOperation;
...
public class InsertCodeEditDataOperation extends CodeEditDataOperation {
    ...
    public InsertCodeEditDataOperation(RBinedAreaCore codeArea, long startPosition, int startCodeOffset, byte value) {
        super(codeArea);
        this.value = value;
    ...
    private static class UndoOperation extends CodeAreaOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(RBinedAreaCore codeArea, long position, CodeType codeType, int codeOffset, long length) {
            super(codeArea);
