 ...
 */
public class SwingCodeAreaCaretPosition implements CodeAreaCaretPosition {

    private long dataPosition = 0;
    private int codeOffset = 0;
    private CodeAreaSection section = null;

    public SwingCodeAreaCaretPosition() {
    }

    public SwingCodeAreaCaretPosition(long dataPosition, int codeOffset, CodeAreaSection section) {
    ...
    public boolean equals(Object obj) {
        ...
        final SwingCodeAreaCaretPosition other = (SwingCodeAreaCaretPosition) obj;
