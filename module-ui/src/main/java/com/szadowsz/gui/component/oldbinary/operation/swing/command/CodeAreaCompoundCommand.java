...
import com.szadowsz.gui.component.oldbinary.operation.BinaryDataCompoundCommand;
import com.szadowsz.gui.component.oldbinary.operation.undo.BinaryDataAppendableCommand;
import com.szadowsz.gui.component.oldbinary.operation.undo.BinaryDataUndoableCommand;
...
public class CodeAreaCompoundCommand extends CodeAreaCommand implements BinaryDataCompoundCommand, BinaryDataAppendableCommand {
    ...
    public CodeAreaCompoundCommand(RCodeAreaCore codeArea) {
        super(codeArea);
    }

    public static CodeAreaCommand buildCompoundCommand(RCodeAreaCore codeArea, CodeAreaCommand... commands) {
