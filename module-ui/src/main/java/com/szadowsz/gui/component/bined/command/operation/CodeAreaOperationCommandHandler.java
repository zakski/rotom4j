...
import com.szadowsz.gui.component.bined.command.*;
import com.szadowsz.gui.component.bined.command.operation.undo.BinaryDataAppendableUndoRedo;
import com.szadowsz.gui.component.bined.command.operation.undo.BinaryDataUndoRedo;
import com.szadowsz.gui.component.bined.settings.*;
import com.szadowsz.gui.component.bined.swing.CodeAreaSwingUtils;
import com.szadowsz.gui.component.bined.swing.SwingCodeAreaCommandHandler;
...
public class CodeAreaOperationCommandHandler implements CodeAreaCommandHandler {
    ...
    public CodeAreaOperationCommandHandler(RBinedAreaCore codeArea, BinaryDataUndoRedo undoRedo) {
        ...
        try {
            ...
            binedDataFlavor = new DataFlavor(BinaryData.class, SwingCodeAreaCommandHandler.BINED_CLIPBOARD_MIME_FULL);
            try {
    ...
    public static CodeAreaCommandHandlerFactory createSwingCodeAreaCommandHandlerFactory() {
        return (RBinedAreaCore codeAreaCore) -> new CodeAreaOperationCommandHandler(codeAreaCore, new CodeAreaUndoRedo(codeAreaCore));
    }
    ...
    public void keyTyped(KeyEvent keyEvent) {
        ...
        if (section != BasicCodeAreaSection.TEXT_PREVIEW) {
            ...
            if (keyValue > SwingCodeAreaCommandHandler.LAST_CONTROL_CODE && keyValue != DELETE_CHAR) {
