...
import com.szadowsz.gui.component.oldbinary.swing.DefaultCodeAreaCommandHandler;
...
public class CodeAreaOperationCommandHandler implements CodeAreaCommandHandler {
    ...
    public CodeAreaOperationCommandHandler(RCodeAreaCore codeArea, BinaryDataUndoRedo undoRedo) {
    ...
    public static CodeAreaCommandHandler.CodeAreaCommandHandlerFactory createDefaultCodeAreaCommandHandlerFactory() {
        return (RCodeAreaCore codeAreaCore) -> new CodeAreaOperationCommandHandler(codeAreaCore, new CodeAreaUndoRedo(codeAreaCore));
    }
