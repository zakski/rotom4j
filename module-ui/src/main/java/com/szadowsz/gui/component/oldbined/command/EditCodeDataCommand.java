...
import com.szadowsz.gui.component.oldbined.capabilities.CodeTypeCapable;
import com.szadowsz.gui.component.oldbined.command.operation.DeleteCodeEditDataOperation;
import com.szadowsz.gui.component.oldbined.command.operation.InsertCodeEditDataOperation;
import com.szadowsz.gui.component.oldbined.command.operation.OverwriteCodeEditDataOperation;
import com.szadowsz.gui.component.oldbined.command.operation.undo.BinaryDataAppendableCommand;
import com.szadowsz.gui.component.oldbined.command.operation.undo.BinaryDataAppendableOperation;
...
public class EditCodeDataCommand extends EditDataCommand implements BinaryDataAppendableCommand {
    ...
    public EditCodeDataCommand(RBinedAreaCore codeArea, EditOperationType editOperationType, long position, int positionCodeOffset, byte value) {
        super(codeArea);
