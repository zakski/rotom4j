...
public class DeleteCodeEditDataOperation extends CodeEditDataOperation {
    ...
    public DeleteCodeEditDataOperation(RCodeAreaCore codeArea, long startPosition, CodeType codeType, byte value) {
        super(codeArea);
        this.value = value;
    ...
    private static class UndoOperation extends InsertDataOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(RCodeAreaCore codeArea, long position, int codeOffset, BinaryData data, byte value) {
