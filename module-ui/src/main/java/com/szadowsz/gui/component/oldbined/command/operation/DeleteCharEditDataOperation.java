...
public class DeleteCharEditDataOperation extends CharEditDataOperation {
    ...
    public DeleteCharEditDataOperation(RBinedAreaCore codeArea, long startPosition, char value) {
        super(codeArea);
        this.value = value;
    ...
    public BinaryDataUndoableOperation executeWithUndo() {
     ...
     private CodeAreaOperation execute(boolean withUndo) {
      ...
      private static class UndoOperation extends InsertDataOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(RBinedAreaCore codeArea, long position, int codeOffset, BinaryData data, char value) {
