 ...
 */
public abstract class RWindowSketch extends PApplet implements RWindow {

    private static final Logger LOGGER = LoggerFactory.getLogger(RWindowSketch.class);
     ...
     */
    public RWindowSketch(String title, int xPos, int yPos, int width, int height, RotomGuiSettings s) {
     ...
     */
    public RWindowSketch(String title, PVector pos, int w, int h, RotomGuiSettings s) {
        super();
