...
import com.szadowsz.nds4j.app.nodes.bin.raw.operation.BinaryDataCompoundCommand;
import com.szadowsz.nds4j.app.nodes.bin.raw.operation.undo.BinaryDataUndoableCommand;
...
public class CodeAreaCompoundCommand extends CodeAreaCommand implements BinaryDataCompoundCommand {
    ...
    public CodeAreaCompoundCommand(CodeAreaSwing codeArea) {
        super(codeArea);
    }

    public static CodeAreaCommand buildCompoundCommand(CodeAreaSwing codeArea, CodeAreaCommand... commands) {
