...
public class InsertCharEditDataOperation extends CharEditDataOperation {
    ...
    public InsertCharEditDataOperation(CodeAreaSwing coreArea, long startPosition, char value) {
        super(coreArea);
        this.value = value;
    ...
    private static class UndoOperation extends CodeAreaOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(CodeAreaSwing codeArea, long position, long length) {
            super(codeArea);
        ...
        private CodeAreaOperation execute(boolean withUndo) {
            ...
            codeArea.setActiveCaretPosition(position, 0);
            return undoOperation;
        }
    }
}
