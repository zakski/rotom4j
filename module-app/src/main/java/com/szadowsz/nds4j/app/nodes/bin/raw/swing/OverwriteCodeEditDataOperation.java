...
import com.szadowsz.nds4j.app.nodes.bin.raw.CodeType;
import com.szadowsz.nds4j.app.nodes.bin.raw.operation.BinaryDataOperation;
...
public class OverwriteCodeEditDataOperation extends CodeEditDataOperation {
    ...
    public OverwriteCodeEditDataOperation(CodeAreaSwing codeArea, long startPosition, int codeOffset, CodeType codeType, byte value) {
        super(codeArea);
        this.value = value;
    ...
    private static class UndoOperation extends CodeAreaOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(CodeAreaSwing codeArea, long position, BinaryData data, CodeType codeType, int codeOffset, long removeLength) {
            super(codeArea);
