 ...
 */
public class CodeAreaScrolling {
    ...
    public CodeAreaScrolling() {
    }

    public void updateCache(DataProvider codeArea, int horizontalScrollBarHeight, int verticalScrollBarWidth) {
        verticalScrollUnit =  codeArea.getVerticalScrollUnit();
        verticalScrollBarVisibility = codeArea.getVerticalScrollBarVisibility();
        horizontalScrollUnit = codeArea.getHorizontalScrollUnit();
        horizontalScrollBarVisibility = codeArea.getHorizontalScrollBarVisibility();
        this.horizontalScrollBarHeight = horizontalScrollBarHeight;
        this.verticalScrollBarWidth = verticalScrollBarWidth;
    }

    
    public ScrollViewDimension computeViewDimension(int dataViewWidth, int dataViewHeight, CodeAreaLayout layout, CodeAreaStructure structure, int characterWidth, int rowHeight) {
