...
public class DeleteCharEditDataOperation extends CharEditDataOperation {
    ...
    public DeleteCharEditDataOperation(CodeAreaSwing codeArea, long startPosition, char value) {
        super(codeArea);
        this.value = value;
    ...
    private CodeAreaOperation execute(boolean withUndo) {
        ...
        codeArea.setSelection(position, position);
        codeArea.repaint();
    ...
    private static class UndoOperation extends InsertDataOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(CodeAreaSwing codeArea, long position, int codeOffset, BinaryData data, char value) {
