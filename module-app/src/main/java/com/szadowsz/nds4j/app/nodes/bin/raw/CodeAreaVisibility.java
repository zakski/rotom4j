 ...
 */
public class CodeAreaVisibility {
    ...
    public void recomputeCharPositions(CodeAreaMetrics metrics, CodeAreaStructure structure, CodeAreaDimensions dimensions, CodeAreaLayout layout, CodeAreaScrolling scrolling) {
