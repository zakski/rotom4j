package com.szadowsz.nds4j.app.utils;

import com.szadowsz.nds4j.file.index.LstFile;
import com.szadowsz.nds4j.utils.FileUtils;
...
public class FileChooser {
     ...
     */
    private static File getFileOnMac(Frame frame, String prompt, FileUtils.ExtensionNameFilter nameFilter, String lastPath) {
     ...
     * @return File that was selected
     */
    private static File getFileOnOther(Frame frame, String prompt, FileUtils.ExtensionFilter filter, String lastPath) {
