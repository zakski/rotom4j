...
public class CodeAreaMouseListener extends MouseAdapter implements MouseMotionListener, MouseWheelListener {
    ...
    public CodeAreaMouseListener(CodeAreaSwing codeArea, JScrollPane view) {
    ...
    private void updateMouseCursor(MouseEvent me) {
        int cursorShape = codeArea.getMouseCursorShape(computeRelativeX(me), computeRelativeY(me));
