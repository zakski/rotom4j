...
public class InsertCodeEditDataOperation extends CodeEditDataOperation {
    ...
    public InsertCodeEditDataOperation(CodeAreaSwing codeArea, long startPosition, int startCodeOffset, byte value) {
        super(codeArea);
        this.value = value;
    ...
    private static class UndoOperation extends CodeAreaOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(CodeAreaSwing codeArea, long position, CodeType codeType, int codeOffset, long length) {
            super(codeArea);
