...
public class OverwriteCharEditDataOperation extends CharEditDataOperation {
    ...
    public OverwriteCharEditDataOperation(CodeAreaSwing coreArea, long startPosition, char value) {
        super(coreArea);
        this.value = value;
    ...
    private static class UndoOperation extends CodeAreaOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(CodeAreaSwing codeArea, long position, BinaryData data, long removeLength) {
            super(codeArea);
