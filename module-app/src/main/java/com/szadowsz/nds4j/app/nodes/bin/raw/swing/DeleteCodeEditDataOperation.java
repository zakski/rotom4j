...
public class DeleteCodeEditDataOperation extends CodeEditDataOperation {
    ...
    public DeleteCodeEditDataOperation(CodeAreaSwing codeArea, long startPosition, CodeType codeType, byte value) {
        super(codeArea);
        this.value = value;
    ...
    private static class UndoOperation extends InsertDataOperation implements BinaryDataAppendableOperation {
        ...
        public UndoOperation(CodeAreaSwing codeArea, long position, int codeOffset, BinaryData data, byte value) {
