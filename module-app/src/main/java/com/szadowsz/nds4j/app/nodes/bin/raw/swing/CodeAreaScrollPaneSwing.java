 ...
 */
public class CodeAreaScrollPaneSwing extends JScrollPane {
    ...
    private final CodeAreaMetrics metrics;
    private final CodeAreaStructure structure;
    private final CodeAreaScrolling scrolling;
    private final CodeAreaDimensions dimensions;
    private final CodeAreaSwing control;

    public CodeAreaScrollPaneSwing(CodeAreaSwing control, CodeAreaMetrics metrics, CodeAreaStructure structure, CodeAreaDimensions dimensions, CodeAreaScrolling scrolling) {
