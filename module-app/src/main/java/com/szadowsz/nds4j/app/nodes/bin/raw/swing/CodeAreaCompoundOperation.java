...
import com.szadowsz.nds4j.app.nodes.bin.raw.operation.BinaryDataCompoundOperation;
...
public class CodeAreaCompoundOperation extends CodeAreaOperation implements BinaryDataCompoundOperation {
    ...
    public CodeAreaCompoundOperation(CodeAreaSwing codeArea) {
        super(codeArea);
    }

    public CodeAreaCompoundOperation(CodeAreaSwing codeArea, CodeAreaCaretPosition backPosition) {
