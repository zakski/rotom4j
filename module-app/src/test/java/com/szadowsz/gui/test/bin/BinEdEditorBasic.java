 ...
 */
package com.szadowsz.gui.test.bin;
...
import com.szadowsz.gui.component.binary.operation.undo.BinaryDataUndoRedoChangeListener;
...
public class BinEdEditorBasic extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        statusBarPanel.add(statusBarSeparator, BorderLayout.PAGE_START);
        ...
        statusBarPanel.add(textStatusPanel, BorderLayout.CENTER);
    ...
    private void editModeLabelMouseClicked(MouseEvent evt) {//GEN-FIRST:event_editModeLabelMouseClicked
    ...
    private void encodingLabelMouseClicked(MouseEvent evt) {//GEN-FIRST:event_encodingLabelMouseClicked
        chooseEncoding();
    }//GEN-LAST:event_encodingLabelMouseClicked

    private void chooseEncodingMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_chooseEncodingMenuItemActionPerformed
        chooseEncoding();
    }//GEN-LAST:event_chooseEncodingMenuItemActionPerformed

    private void binaryCodeTypeRadioButtonMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_binaryCodeTypeRadioButtonMenuItemActionPerformed
        codeArea.setCodeType(CodeType.BINARY);
    }//GEN-LAST:event_binaryCodeTypeRadioButtonMenuItemActionPerformed

    private void octalCodeTypeRadioButtonMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_octalCodeTypeRadioButtonMenuItemActionPerformed
        codeArea.setCodeType(CodeType.OCTAL);
    }//GEN-LAST:event_octalCodeTypeRadioButtonMenuItemActionPerformed

    private void decimalCodeTypeRadioButtonMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_decimalCodeTypeRadioButtonMenuItemActionPerformed
        codeArea.setCodeType(CodeType.DECIMAL);
    }//GEN-LAST:event_decimalCodeTypeRadioButtonMenuItemActionPerformed

    private void hexadecimalCodeTypeRadioButtonMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_hexadecimalCodeTypeRadioButtonMenuItemActionPerformed
        codeArea.setCodeType(CodeType.HEXADECIMAL);
    }//GEN-LAST:event_hexadecimalCodeTypeRadioButtonMenuItemActionPerformed

    private void upperCaseRadioButtonMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_upperCaseRadioButtonMenuItemActionPerformed
        codeArea.setCodeCharactersCase(CodeCharactersCase.UPPER);
    }//GEN-LAST:event_upperCaseRadioButtonMenuItemActionPerformed

    private void lowerCaseRadioButtonMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_lowerCaseRadioButtonMenuItemActionPerformed
