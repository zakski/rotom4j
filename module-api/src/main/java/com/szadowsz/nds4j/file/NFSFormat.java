...
public enum NFSFormat {
    ...
    private static final Map<String, NFSFormat> BY_LABEL = new HashMap<>();
    // Mapping of Format by File name extension
    private static final Map<String, NFSFormat> BY_EXT = new HashMap<>();

    // Initialise static maps
    static {
        for (NFSFormat e: values()) {
     ...
     */
    NFSFormat(String[] magic, String[] extension) {
        this.magic = magic;
        this.ext = extension;
    }
     ...
     */
    public static NFSFormat valueOfLabel(String label) {
